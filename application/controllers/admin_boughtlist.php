...
class admin_boughtlist extends CI_Controller {
    ...
    function basket_detail(){
        ...
        $data['address'] = $this->Bought_listModel->selectDataByUserID2($_POST['userid'],$_POST['cartid'])[0]->address;
        $data['zipcode'] = $this->Bought_listModel->selectDataByUserID2($_POST['userid'],$_POST['cartid'])[0]->zipcode;
        $data['tel'] = $this->Bought_listModel->selectDataByUserID2($_POST['userid'],$_POST['cartid'])[0]->tel;
