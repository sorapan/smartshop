    ...
    <div class="col-xs-12 card">
        ...
        <div class="form-horizontal">
            <div class="form-group">
                <label for="maintype" class="control-label col-xs-2">ชื่อประเภท</label>
                <div class="col-xs-6">
                    <input type="text" id="maintype" class="form-control col-xs-8">
                </div>
                <span id="warnmaintype" class="col-xs-2" style="color:red"></span>
            </div>
            <div class="form-group">
        ...
        <div  class="col-xs-12">
            <ul id="managemaintype" class="list-group col-xs-6 col-xs-offset-2">
        ...
        <div class="form-horizontal">
            <div class="form-group">
                <label for="subtype" class="control-label col-xs-2">ชื่อประเภท</label>
                <div class="col-xs-6">
                    <input type="text" id="subtype" class="form-control col-xs-8">
                </div>
                <div class="col-xs-4">
            ...
            <div class="col-xs-10 col-xs-offset-2" style="color:red"><p id="warnsubtype"></p></div>
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
        ...
        <div class="col-xs-12 marginbot">
            <ul id="managesubtype" class="col-xs-8 col-xs-offset-2" style="list-style-type:none;">
                <li><h4>sssss</h4>
                    <ul class="list-group">
