...
<div style="background-color: #e7e7e7">
    ...
    <footer class="col-xs-12">
        ...
        <div class="container" style="background-color: #4caad9">

            <div class="col-xs-3 footer-content col-xs-offset-2">
            ...
            <div class="col-xs-3 footer-content">
                ...
                <address>
                    ...
                    <abbr title="Phone">โทร:</abbr> (074) 456-7890<br>
                    <abbr>Email:</abbr> rudeboy04forplay@gmail.com
                </address>
            </div>
